...
import copy
import numpy as np
#from scipy.optimize import linprog OptimizeResult, _check_unknown_options

# Technically I just copied scipy's linprog module code
"""
...
def allocate_ads(n, m, A, b, c):
    ret = linprog(-np.array(c), A, b, options = {'tol':1e-3, 'bland':True}) # 'maxiter':1000
    if 3 == ret.status:
        ans = 1
        x = None
    elif 0 == ret.status:
